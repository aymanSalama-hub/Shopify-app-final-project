...
class CardItemLoading extends CardOrderState {}

class CardItemLoaded extends CardOrderState {}

/// Error state with an optional message to surface to the UI
class CardItemError extends CardOrderState {
  final String message;
  CardItemError([this.message = 'An error occurred. Please try again.']);
}
